...
Thereby, the distance of the pattern in a) and b) in figure \ref{fig:vertical} is $\dfrac{6 + \dfrac{1^2}{5}{5} = \dfrac{6 + \dfrac{1}{5}}{5} = \dfrac{\dfrac{31}{5}}{5} = \dfrac{31}{25} = 1 + \dfrac{6}{25} = 1.24$. Further, the distance of a) and c) is $\dfrac{6 + \dfrac{5^2}{5}}{5} = \dfrac{6 + \dfrac{25}{5}}{5} = \dfrac{11}{5} = 2 + \dfrac{1}{5} = 2.2$.
%c -> matrix
TODO:c,b,d/L\\
TODO:example\\
