...
\def\projectType{Master Thesis in Bioinformatics}

% define names
\def\supervisorIname{Professor Dr. Verena Wolf}
\def\advisorIname{Alexander L\"{u}ck}
\def\reviewerName{Professor Dr. Volkhard Helms}
