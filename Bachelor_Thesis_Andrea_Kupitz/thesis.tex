...
\def\projectname{Haplotype Phasing from Hi-C data} 
\def\projectType{Bachelor's Thesis in Bioinformatics}

% define names
\def\supervisorIname{Professor Dr. Tobias Marschall}
\def\advisorIname{Shilpa Garg}
\def\reviewerName{reviewer2}
\def\authorFirstName{Andrea}
\def\authorLastName{Kupitz}

% define date and city
\def\date{September 2017}
